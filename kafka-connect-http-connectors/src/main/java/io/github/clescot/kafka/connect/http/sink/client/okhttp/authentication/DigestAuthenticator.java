...
/**
 * from https://github.com/clescot/okhttp-digest which is a fork of
 * https://github.com/rburgst/okhttp-digest (pull request https://github.com/rburgst/okhttp-digest/pull/82 requested).
...
public class DigestAuthenticator implements CachingAuthenticator {
    ...
    private final com.burgstaller.okhttp.digest.Credentials credentials;
    ...
    public DigestAuthenticator(com.burgstaller.okhttp.digest.Credentials credentials) {
        this.credentials = credentials;
        this.credentialsCharset = StandardCharsets.US_ASCII;
        this.random = new SecureRandom();
    }

    public DigestAuthenticator(com.burgstaller.okhttp.digest.Credentials credentials, Charset credentialsCharset) {
        this.credentials = credentials;
        this.credentialsCharset = credentialsCharset;
        this.random = new SecureRandom();
    }

    public DigestAuthenticator(com.burgstaller.okhttp.digest.Credentials credentials, Charset credentialsCharset, Random random) {
        this.credentials = credentials;
        this.credentialsCharset = credentialsCharset;
        this.random = random;
    }
