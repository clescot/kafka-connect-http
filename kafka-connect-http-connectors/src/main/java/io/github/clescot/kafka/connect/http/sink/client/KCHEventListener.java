...
public class KCHEventListener {
    ...
    protected KCHEventListener(MeterRegistry registry, String requestsMetricName,
    ...
    KCHEventListener(MeterRegistry registry, String requestsMetricName, Function<HttpRequest, String> urlMapper,
    ...
    public static KCHEventListener.Builder builder(MeterRegistry registry, String name) {
        return new KCHEventListener.Builder(registry, name);
    }
    ...
    public static class Builder {
        ...
        public KCHEventListener.Builder tags(Iterable<Tag> tags) {
         ...
         * @since 1.5.0
         */
        public KCHEventListener.Builder tag(Tag tag) {
         ...
         * @since 1.5.0
         */
        public KCHEventListener.Builder tag(BiFunction<HttpRequest, HttpResponse, Tag> contextSpecificTag) {
            this.contextSpecificTags.add(contextSpecificTag);
            return this;
        }

        public KCHEventListener.Builder uriMapper(Function<HttpRequest, String> uriMapper) {
         ...
         * @since 1.5.0
         */
        public KCHEventListener.Builder includeHostTag(boolean includeHostTag) {
            this.includeHostTag = includeHostTag;
            return this;
        }
         ...
         * @since 1.3.9
         */
        public KCHEventListener.Builder requestTagKeys(String... requestTagKeys) {
         ...
         * @since 1.3.9
         */
        public KCHEventListener.Builder requestTagKeys(Iterable<String> requestTagKeys) {
            this.requestTagKeys = requestTagKeys;
            return this;
        }

        public KCHEventListener build() {
            return new KCHEventListener(registry, name, uriMapper, tags, contextSpecificTags, requestTagKeys,
                    includeHostTag);
        }
