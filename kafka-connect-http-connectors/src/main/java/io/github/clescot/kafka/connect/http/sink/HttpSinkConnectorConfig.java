...
public class HttpSinkConnectorConfig extends AbstractConfig {
    ...
    public HttpSinkConnectorConfig(ConfigDef configDef, Map<?, ?> originals) {
        ...
        this.producerTopic = getString(PRODUCER_TOPIC);
